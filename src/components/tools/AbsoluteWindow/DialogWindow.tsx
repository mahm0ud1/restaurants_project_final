...
import { DialogContainerStyle, DialogOuterContainerStyle } from './Style'
import { CloseButtonStyle, PopupBodyStyle, PopupPageStyle, PopupTitleStyle } from '../../menuButtons/Style';
